        ...
        <tr>
                    ...
                    <td>
                        <form action="" method="post" class="header-search d-flex">
                            <input type="search" name="search" class="input-text header-searchbar form-control " placeholder="Search Doctor name or Email " list="doctors" value="<?php echo $insertkey; ?>" style="margin-left: 10px;">
                            &nbsp;&nbsp;
            ...
            <?php
                ...
                <tr >
                    <td colspan="2" style="padding-top:30px;">
                        <p class="heading-main12" style="font-size:20px;color:rgb(49, 49, 49)">Add New Doctor</p>
                    </td>
                    <td colspan="">
                        <a href="?action=add&id=none&error=0" class="non-style-link"><button  class="btn btn-primary  "  style="display: flex;justify-content: center;align-items: center;">Add New</font></button></a>
                    </td>
                    </tr>
                <tr>
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <tr>
                            ...
                            <tr>
                                <td>
                                    <p style="padding: 0;margin-left: 10px;text-align: left;font-size: 25px;font-weight: 500;">Add New Doctor.</p><br><br>
                                </td>
                            </tr>
